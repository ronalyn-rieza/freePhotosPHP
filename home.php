...
?>
<title>freePhotos.io - Home Page</title>
<?php
 ...
 ?>
            ...
            <div class="images-grid__item reveal-item" id="">
               <div class='images-grid__item--imgs'>
                ...
                <?php
                    //show if the user already like the image
    ...
    if($image_count > $shownimg_num){
      ...
      echo "<div class='pagination'>"; // pagination row div
        ...
        if($page > 1 ){
            ...
            echo "<li class='btn pagination__item-prev'><a class='' href='home.php?page=$j'>Prev</a></li>";
       ...
       if($count > 1){
        ...
        if($page < $count ){
           ...
           echo "<li class='btn pagination__item-next'><a class='' href='home.php?page=$j'>Next</a></li>";
